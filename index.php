...
<head>
  ...
  <title>Pedro Luiz | Dashboard</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: green;">
    ...
    <a href="index3.html" class="brand-link">
      <img src="dist/img/questao.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .5">
      <span class="brand-text font-weight-light">AV 2</span>
    </a>
